...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private TextInputEditText userNameEdt, passwordEdt, firstNameEdt, lastNameEdt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String fst = firstNameEdt.getText().toString();
                String lst = lastNameEdt.getText().toString();

                // checking if the password and confirm password is equal or not.
                if (TextUtils.isEmpty(userName) && TextUtils.isEmpty(pwd) && TextUtils.isEmpty(fst) && TextUtils.isEmpty(lst)) {
