...
public class Medicine29 extends AppCompatActivity {
    FirebaseDatabase firebaseDatabase;
    private FirebaseAuth mAuth;

    ListView listView;
    String mTitle[] = {"GRAVINATE","MOTILIUM"};

    String mDescription[] = {"Gravinate syrup is used to prevent nausea and vomiting. It is a combination medicine containing doxylamine and pyridoxine as active ingredient.\n\n"+ "یہ متلی اور الٹی کو روکنے کے لیے استعمال ہوتا ہے۔",
    ...
    int images[] = {R.drawable.gravinate2,R.drawable.motilium};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.medicine29);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.idLogOut:
                ...
                Intent i = new Intent(Medicine29.this, LoginActivity.class);
                startActivity(i);
                this.finish();
                return true;
            default:
