...
public class Medicine8 extends AppCompatActivity {
    FirebaseDatabase firebaseDatabase;
    private FirebaseAuth mAuth;

    ListView listView;
    String mTitle[] = {"GRAVINATE","MOTILIUM","DOMEL"};

    String mDescription[] = {"Gravinate Tablet is used to prevent nausea and vomiting during pregnancy. It is a combination medicine containing doxylamine and pyridoxine as active ingredient.\n\n"+ "یہ حمل کے دوران متلی اور الٹی کو روکنے کے لیے استعمال کیا جاتا ہے۔",
            ...
            "Domel tablet 10MG is used to treat nausea and vomiting and stomach pain.\n\n"+
                    "یہ متلی اور الٹی اور پیٹ کے درد کے علاج کے لیے استعمال ہوتا ہے۔"};

    int images[] = {R.drawable.gravinate,R.drawable.motilium,R.drawable.domel};

    String mDosage[] = {"Take 1 tablet orally every 4 to 6 hours as needed.\n\n"+"ضرورت کے مطابق ہر 4 سے 6 گھنٹے بعد 1 گولی لیں۔" ,
            "Take this medication one or 2 tablespoon every 4 - 8 hours daily.\n" +
            "\n"+"اس دوا کو ہر 4 سے 8 گھنٹے میں ایک یا 2 چمچ روزانہ لیں۔\n" ,
            "Take 1 tablet every 4 - 8 hours.\n" +
            "\n" + "ہر 4-8 گھنٹے میں 1 گولی لیں۔\n"};

    String mSideEffects[] = {"Drowsiness, headache, blurred vision, tinnitus, dryness of the mouth and respiratory passages, incoordination, palpitation, dizziness, hypotension.\n\n"+"غنودگی، سر درد، دھندلا پن، ٹنائٹس، منہ اور سانس کی نالیوں کا خشک ہونا، ہم آہنگی، دھڑکن، چکر آنا، ہائپوٹینشن۔",
            ...
            "Common side effects like dry mouth, dizziness, tiredness, chest pain, difficulty in breathing, heartburn.\n" +
                    "\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.medicine8);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.idLogOut:
                ...
                Intent i = new Intent(Medicine8.this, LoginActivity.class);
                startActivity(i);
                this.finish();
                return true;
            default:
